...
import com.james.controller.InterfaceDAO;
import com.james.model.sql.DAO;
...
public class SQLModelChecks {
    ...
    public class DAOMethodChecks {
        ...
        void testFindingAllEmployees() {
            ...
            EmployeeDTO employeeDTO2 = Mockito.mock(EmployeeDTO.class);
            EmployeeDTO employeeDTO3 = Mockito.mock(EmployeeDTO.class);
            EmployeeDTO employeeDTO4 = Mockito.mock(EmployeeDTO.class);
        ...
        void testFindByIDMethod(){
            InterfaceDAO<EmployeeDTO> interfaceDAO = new DAO();
            assertEquals(null, interfaceDAO.findById(1));
        }
